...
export const authRoute: Routes = {
  "/login": {
    ...
    async POST(req) {
      ...
      const credenciaisValidas = username === "fatec" && password === "fatec"; //TODO ISSO AQUI É SÓ PRA TESTE NÃO VAI FICAR PARA PRODUÇÃO
  ...
  "/logout": {
    POST() {
      ...
      return new Response(null, {
        ...
        headers: {
          Location: "/login",
          //? A lógica é simples, ele simplesmente sobrescreve o cookie de autenticação válido por "nada" (vazio)
